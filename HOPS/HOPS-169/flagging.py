FontUV='HOPS-169_flagging'

os.system('cp -r HOPS-169.ms tmp.ms')
...
#rms:
#noselfcal: 0.316 mJy		1st_selfcal: 0.104 mJy		2nd_selfcal: 0.099 mJy		3rd_selfcal: 0.090 mJy

#peak:
#noselfcal: 202.337mJy		1st_selfcal: 209.362 mJy	2nd_selfcal: 209.377 mJy	3rd_selfcal: 210.52 mJy
...
# rms_StokesQ: 0.070 mJy		# rms_StokesU: 0.072 mJy		# rms_StokesV: 0.072 mJy
...
# rms_StokesQ: 0.070 mJy		# rms_StokesU: 0.071 mJy		# rms_StokesV: 0.072 mJy
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.18mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.14mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.144mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
# 'HOPS-169_noflagging.POLA'['HOPS-169_noflagging.POLI'>0.000294]
...
os.system('cp -r HOPS-169_noflagging.selfcal.ms HOPS-169_flagging.selfcal.ms')
...
flagdata(vis=FontUV+'.selfcal.ms',
    spw='0:926~1048, 0:1071~1099, 1:1602~1606, 1:1896~1899, 2:364~370, 3:14~20, 3:357~363, 3:560~564, 3:1873~1878',
    flagbackup=False)
...
# 'HOPS-169_flagging.POLA'['HOPS-169_flagging.POLI'>0.000294]
