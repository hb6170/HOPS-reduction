FontUV='HOPS-11_flagging'

os.system('cp -r HOPS-11.ms tmp.ms')
...
#rms:
#noselfcal: 0.389 mJy		1st_selfcal: 0.102 mJy		2nd_selfcal: 0.093 mJy		3rd_selfcal: 0.087 mJy

#peak:
#noselfcal: 225.406 mJy	1st_selfcal: 237.54 mJy	2nd_selfcal: 238.589 mJy	3rd_selfcal: 240.047 mJy
...
# rms_StokesQ: 0.061 mJy		# rms_StokesU: 0.060 mJy		# rms_StokesV: 0.060 mJy
...
# rms_StokesQ: 0.061 mJy		# rms_StokesU: 0.060 mJy		# rms_StokesV: 0.061 mJy
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.174mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.122mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
tclean(vis=FontUV+'_noflagging.selfcal.ms',
    ...
    weighting='briggs',
    robust=0.5,
    threshold='0.12mJy',  # 2sigma rms of 3rd_selfcal
    pblimit=-1,
    niter=1000000,
    usemask='auto-multithresh',
    negativethreshold=0.0,
...
'HOPS-11_noflagging.POLA'['HOPS-11_noflagging.POLI'>0.000255]
...
os.system('cp -r HOPS-11_noflagging.selfcal.ms HOPS-11_flagging.selfcal.ms')
...
'HOPS-11_flagging.POLA'['HOPS-11_flagging.POLI'>0.000255]
...
immath(outfile=FontUV+'.subtraction.POLA',
    mode='evalexpr',
    imagename=['HOPS-11_cont_avg.flagging.POLA','HOPS-11_cont_avg.POLA'],
...
immath(outfile=FontUV+'.subtraction.POLI',
    mode='evalexpr',
    imagename=['HOPS-11_cont_avg.flagging.POLI','HOPS-11_cont_avg.POLI'],
    expr='IM0-IM1')
